...
const fileToGenerativePart = async (file: File): Promise<Part> => {
  const base64EncodedData = await new Promise<string>((resolve, reject) => {
    ...
    // Using substring and indexOf avoids intermediate array allocation during string splitting.
    // This significantly reduces memory overhead and CPU time for large base64 image payloads.
    reader.onload = () => {
