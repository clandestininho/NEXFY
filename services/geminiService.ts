...
// Cache File parts to avoid redundant base64 conversions when generating multiple mockups
...
const fileToGenerativePart = async (file: File): Promise<Part> => {
  ...
  const base64EncodedData = await new Promise<string>((resolve, reject) => {
    ...
    // Use substring instead of split to prevent large array allocations during extraction
    reader.onload = () => {
