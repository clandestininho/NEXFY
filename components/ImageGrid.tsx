...
// ⚡ Bolt: Memoize ImageGrid to prevent unnecessary re-renders when parent states
// (e.g., isDragActive or selectedBackground) change. This is critical for performance
// because the `images` prop contains large base64 data payloads.
