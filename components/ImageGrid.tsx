...
// ⚡ Bolt: Memoize ImageGrid to prevent re-rendering massive base64 image strings
// Impact: Skips costly React diffing when parent state (like selectedBackground) changes
