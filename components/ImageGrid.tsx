...
// ⚡ Bolt: Prevent unnecessary re-renders of large image payloads
// 📊 Impact: Significantly reduces UI diffing time when parent components (like Background style picker) change
