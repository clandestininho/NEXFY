...
// ⚡ Bolt: Memoize ImageGrid to prevent expensive re-rendering and diffing
// of the large base64 image array when unrelated state (like the background
// style dropdown) changes in the parent component.
