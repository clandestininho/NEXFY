...
// Memoize ImageGrid to prevent expensive re-rendering of large base64 image strings
// when the parent App component updates (e.g., during input changes or progress updates).
const ImageGrid = React.memo(({ images, onDownload }: ImageGridProps) => {
  return (
