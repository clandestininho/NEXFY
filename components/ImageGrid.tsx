...
// ⚡ Bolt Optimization: Wrap component in React.memo to prevent expensive UI
// re-rendering and DOM diffing on large base64 image arrays when unrelated
// state in the parent App component changes.
