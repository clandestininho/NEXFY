...
function App() {
  ...
  // ⚡ Bolt: Memoize handleDownload so its reference is stable across App re-renders.
  // This ensures the React.memo optimization on ImageGrid is not broken when parent state updates.
